...
public class UniversityFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        expandableListView = (ExpandableListView) getActivity().findViewById(R.id.expandable_university);
        MyAdapter adapter = new MyAdapter(getActivity(), CourseLab.getInstance(getActivity()).getCourseCategory(1));
        ...
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                intent.putExtra(Utils.EXTRA_INTENT_ENROLL_TYPE, 1);
    ...
    class MyAdapter extends BaseExpandableListAdapter {
        ...
        public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
            ...
            switch (groupPosition) {
                case 0:
                    textCategory.setText(R.string.programming);
                    break;
                case 1:
                    textCategory.setText(R.string.computer);
                    break;
                case 2:
                    textCategory.setText(R.string.gen_uni);
                    break;
            }
